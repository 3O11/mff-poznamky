...
Model náhody napr. kostka 1,\dots,6,\\
...
\begin{example}
    ...
    Příklad (Schwartz-Zippel algoritmus):
    
    Dány dva polynomy $f(x),g(x)$ stupně $d$. Chcem zjistit, zda jsou stejné, 
    a to co nejrychleji.
...
\begin{enumerate}
    ...
    \item náhodné grafy (Ramsayovy čísla)
\end{enumerate}
\noindent
Pro popis pomocí teorie pravděpodobnosti napřed vybereme množinu elementárních jevů
(sample space)$\Omega$
...
"A je jistý jev" znamená $P(A) = 1.$ Také se říká, že A nastáva skoro jistě (almost surely), zkráceně s.j. (a.s.).
...
\begin{theorem}
    ...
    \begin{enumerate}
        ...
        \item trik zdisjunktnení: z $A_1,A_2...$ uděláme disjunktní množiny
         ...
         \[\subseteq ok\]
         \[\text{opačná inklúziua \textbf{TODOOT}}\]
    \end{enumerate}
...
\begin{example}
    ...
    \begin{enumerate}
        \item Konečný s uniformní pravděpodobností\\
        ...
        \item Bernoulliho krychle - nekonečné opakování\\
